...
| 태스크 ID | 제목 | 우선순위 | 상태 |
|-----------|------|----------|------|
| F8-BE-01 | 월간 요약 API | 🔴 P1 | ⭕ |
| F8-BE-02 | 카드별 요약 API | 🔴 P1 | ⭕ |
| F8-BE-03 | 카테고리별 API | 🔴 P1 | ⭕ |
| F8-BE-04 | 6개월 추이 API | 🔴 P1 | ⭕ |
| F8-FE-05 | 프론트 타입 정의 | 🔴 P1 | ⭕ |
| F8-FE-06 | 그룹 대시보드 전환 | 🟢 P3 | ❌ 미착수 |
| F2-FE-01 | 결제 수정/삭제 UI | 🔴 P1 | ⭕ |
| F2-FE-02 | 결제 입력 폼 고도화 | 🟡 P2 | 🔶 부분 (API 완료) |
| F2-FE-03 | 해외결제(FX) UI | 🟡 P2 | ❌ 미착수 |
| F2-FE-04 | 결제 보정 UI 확인 | 🟡 P2 | 🔶 확인 필요 |
| F2-FE-05 | 실적 제외 토글 UI | 🟢 P3 | ❌ 미착수 |
| F2-BE-06 | card_benefit 자동 매칭 | 🟢 P3 | ❌ 미착수 |
| F4-BE-01 | TierChangedEvent 발행 | 🟡 P2 | ⭕ |
| F4-FE-02 | 구간 달성 모달 | 🟡 P2 | ⭕ |
